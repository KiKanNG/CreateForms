...
func U01() -> Form {
    ...
    do {
        ...
        section.addCell(Cell(type: .ShortInput, description: "Voltage", descriptionId: "volt", placeholder: "", unit: .volt))
        section.addCell(Cell(type: .ShortInput, description: "Current", descriptionId: "current", placeholder: "", unit: .ampere))
        section.addCell(Cell(type: .ShortInput, description: "Battery runtime (hr)", descriptionId: "battery_runtime", placeholder: "", unit: .hour))
    ...
    do {
        ...
        section.addCell(Cell(type: .LongInput, description: "Power factor", descriptionId: "power_factor", placeholder: "Power Factor", unit: .none))
